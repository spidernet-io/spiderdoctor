...
CONTROLLER_LABEL="app.kubernetes.io/component=spiderdoctor-controller"
AGENT_LABEL="app.kubernetes.io/component=spiderdoctor-agent"
...
if [ "$TYPE"x == "system"x ] ; then
    ...
    echo ""
    echo "=============== spiderdoctor-controller describe ============== "
    ...
    echo ""
    echo "=============== spiderdoctor-agent describe ============== "
    ...
    echo ""
    echo "=============== spiderdoctor-controller logs ============== "
    for POD in $CONTROLLER_POD_LIST ; do
      echo ""
    ...
    echo ""
    echo "=============== node log  ============== "
    KIND_CLUSTER_NAME=${KIND_CLUSTER_NAME:-"spiderdoctor"}
