...
import (
	...
	"github.com/spidernet-io/spiderdoctor/api/v1/controllerServer/server/restapi/healthy"
)

//go:generate swagger generate server --target ../../controllerServer --name HTTPServerAPI --spec ../openapi.yaml --api-package restapi --server-package server --principal interface{} --default-scheme unix --exclude-main
