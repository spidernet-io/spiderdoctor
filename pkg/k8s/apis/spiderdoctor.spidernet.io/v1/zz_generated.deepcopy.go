...
func (in *NetFailureCondition) DeepCopyInto(out *NetFailureCondition) {
	*out = *in
	if in.MinAccessFailure != nil {
		in, out := &in.MinAccessFailure, &out.MinAccessFailure
		*out = new(uint64)
		**out = **in
	}
	if in.MinAccessDelayMs != nil {
		in, out := &in.MinAccessDelayMs, &out.MinAccessDelayMs
		*out = new(uint64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetFailureCondition.
func (in *NetFailureCondition) DeepCopy() *NetFailureCondition {
	if in == nil {
		return nil
	}
	out := new(NetFailureCondition)
	in.DeepCopyInto(out)
	return out
}
