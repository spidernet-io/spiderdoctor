...
var _ = Describe("unit test", Label("unit test"), func() {
	...
	It("test getMissRemoteReport", Pending, func() {
		...
		name1 := "Nethttp_test-agent_round1_spiderdoctor-worker_2022-12-21T11:47:08Z"
		name2 := "Nethttp_test-agent_round1_spiderdoctor-control-plane_2022-12-21T11:45:08Z"
	...
	It("test2 getMissRemoteReport", func() {
		...
		remoteFileList := []string{
			"Nethttp_test-agent_round1_spiderdoctor-worker_2022-11-21T12:24:08Z",
			"Nethttp_test-agent_round2_spiderdoctor-worker_2022-11-21T12:26:07Z",
		}

		localFileList := []string{
			"Nethttp_test-agent_round1_spiderdoctor-control-plane_2022-12-21T12:18:20Z",
			"Nethttp_test-agent_round1_spiderdoctor-worker_2022-12-21T12:18:20Z",
